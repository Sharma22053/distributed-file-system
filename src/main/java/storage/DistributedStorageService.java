...
public class DistributedStorageService {
    ...
    public byte[] get(String key) {
        ...
        if (isLocalOwner(primaryOwner)) {
            ...
            System.out.println(
                    "[DistributedStorage] Fetching GET from remote owner " + primaryOwner + " for key: " + key);
    ...
    public boolean delete(String key) {
        ...
        if (isLocalOwner(primaryOwner)) {
            ...
            System.out.println(
                    "[DistributedStorage] Forwarding DELETE to remote owner " + primaryOwner + " for key: " + key);
